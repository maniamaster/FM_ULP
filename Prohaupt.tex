...
\subsection{Räumliche Verzerrungen}
...
schrägen Glas ein, was in \cref{abb:spatialchirp} aufgezeigt ist.

\subsection{Prismenkrompressor}
Mithilfe des Prismnenkompressors (PC) kann ein gechirpter Puls wieder zu einem
(nahezu) fourierlimitierten Puls komprimiert werden. Der Aufbau des
Prismnenkompressors ist in \cref{abb:pc} zu sehen. Der Puls durchquert zwei
